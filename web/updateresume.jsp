...
<sql:query dataSource="${dbsourcess}" var="bike">
                    SELECT *  from registration where mobile="${sessionScope["mobile"]}" ;
                </sql:query>
...
<div class="wrapper">
	...
	<form class="form" action="updateresumeconnect.jsp" method="post">
		<div class="form">
                    
                    <div class="inputfield">
	          <label>Id</label>
                  <input type="text" class="input" id="id1" name="id" value="${truck.id}" >
	       </div>
                    
	       <div class="inputfield">
	          <label>User Name</label>
                  <input type="text" class="input" id="fname" name="fname" value="${truck.fname}" >
	       </div>


	        <div class="inputfield" >
	          <label>Any Experience(yrs)</label>
	        ...
	        <div class="inputfield">
	          ...
	          <div class="custom_select" >
	            <select id="rq" name="rq">
	              <option value="${truck.rq}">Don't Change</option>
