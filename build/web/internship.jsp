...
<html lang="en" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="styleinternship.css">
    ...
    <body>
        ...
        <sql:query dataSource="${dbsources}" var="tempo">
            SELECT *  from userdetail where mobile="${mobile}" ;
             ...
             <sql:query dataSource="${dbsources}" var="flute">
            SELECT count(*) as c  from registration where mobile="${mobile}" ;
        </sql:query>
            <c:set value="${flute.rows}" var="v"></c:set>
        ...
        <c:forEach var="car" items="${tempo.rows}">
            ...
            <div class="wrapper design" >
                ...
                <nav id="sidebar">
                    <div class="title">
                        Account Details</div>
                    <div class="list-items" style="color:white">
                        <li> <p>ID:${car.id}</p></li>
                        <li><p>Name:${car.name}</p></li>
                        <li><p>Password:${car.password}</p></li>
                        <li><p>Usertype:${car.usertype}</p></li>
                        <li><p>Mobile Number:${car.mobile}</p></li>
                        
                        
                        <%--<c:forEach var="egg" items="${flute.rows}">--%>
   
                        <c:choose>

                                    <c:when test = "${v[0].c gt 0}">
                                        <li> <p>Resume:Filled</p></li>
                                    </c:when>
                                        
                                    <c:otherwise>
                                        <li> <p>Resume:Unfilled</p></li>
                                    </c:otherwise>
        ...
        <sql:setDataSource driver="com.mysql.jdbc.Driver" var="dbsources1" url="jdbc:mysql://localhost:3306/ebank" user="root" password=""/>
        <c:set value='${sessionScope["mobile"]}' var="mobile" />

        <sql:query dataSource="${dbsources1}" var="dogs">
            SELECT * from userdetail;
        </sql:query>

        <sql:query dataSource="${dbsources1}" var="tempos">
            SELECT *  from userdetail where mobile="${mobile}" ;
        </sql:query>

        <c:forEach var="cars" items="${tempos.rows}">
            <nav class ="navdesign">
                <nav>
                    ...
                    <ul>
                        ...
                        <li><a href="#">Account
                            ...
                            <ul>
                                ...
                                <li><a href="updatemobile.jsp">Update Mobile Number</a>
                        ...
                        <li><a href="#">Resume
                            ...
                            <ul>
                                ...
                                <li><a href="registrationform.jsp">Fill Resume</a></li>
                        ...
                        <li class="nav-item1 dropdown1">
                            <a class="nav-link1 dropdown-toggle1" href="#" id="userDropdown1" role="button" data-toggle="dropdown">
                                <span class="mr-21 d-none1 d-lg-inline1 text-gray-6001 small1"> Welcome ${cars.name} ! </span>
    ...
    <center><h1 style="color: red"> <br>Fill Resume Before Applying !<br>(If filled already ignore this message)</h1></center>
        ...
        <c:forEach var="box" items="${info.rows}">
            <div class="main1" >
                <div class="row1 " >
                    ...
                    <div class="card1 card " style="background-color:white" >
                            ...
                            <div class="card-body1">
                                ...
                                <c:choose>
                                    ...
                                    <c:when test = "${box.iname_id == 1}">
                                        <button name="apply" >
                                            <a href="internapply.jsp" >Apply</a>
                                        </button>
                                    </c:when>

                                    <c:when test = "${box.iname_id == 2}">
                                        <button name="apply" >
                                            <a href="fullapply.jsp" >Apply</a>
                                        </button>
                                    </c:when>

                                    <c:when test = "${box.iname_id == 3}">
                                        <button name="apply" >
                                            <a href="paidapply.jsp" >Apply</a>
                                        </button>
                                    </c:when>
                                    <c:when test = "${box.iname_id == 4}">
                                        <button name="apply" >
                                            <a href="jobapply.jsp" >Apply</a>
                                        </button>
                                    </c:when>
